...
const TrendingProductBoady = ({ product }: { product: TProducts }) => {
  return (
    <div key={product._id} className="card card-compact  bg-base-100 shadow-md">
      <figure>
...
export default TrendingProductBoady;
